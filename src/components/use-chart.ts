...
const baseChartOptions = (theme: Theme): ChartOptions => {
  ...
  return {
    ...
    chart: {
      ...
      foreColor: theme.vars?.palette?.text?.disabled || theme.palette.text.disabled,
      animations: {
        enabled: true,
        speed: 360,
    ...
    markers: {
      size: 0,
      strokeColors: theme.vars?.palette?.background?.paper || theme.palette.background.paper,
    },
    ...
    legend: {
      ...
      labels: { colors: theme.vars?.palette?.text?.primary || theme.palette.text.primary },
    ...
    plotOptions: {
      ...
      radialBar: {
        ...
        track: {
          margin: -8,
          strokeWidth: '50%',
          background: theme.vars?.palette?.grey?.['500Channel']
      ...
      radar: {
        polygons: {
          ...
          connectorColors: theme.vars?.palette?.divider || theme.palette.divider,
        },
      },
      /**
       * polarArea
       ...
       */
      polarArea: {
        rings: { strokeColor: theme.vars?.palette?.divider || theme.palette.divider },
        spokes: { connectorColors: theme.vars?.palette?.divider || theme.palette.divider },
      },
      /**
       * heatmap
