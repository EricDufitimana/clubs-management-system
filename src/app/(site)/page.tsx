...
import { MonitorSmartphone, ShieldCheck, Server, Clock1, Users2 } from 'lucide-react';
    ...
    <>
      <div className="p-16 min-h-screen">
        <section className="max-w-3xl mx-auto ">
          ...
          <h1 className='text-center text-grey-900 text-2xl font-normal max-w-md mx-auto mt-12 mb-12 '>We streamline club operations and management</h1>
          <HeaderParagraph 
          ...
          />
          <div className="grid grid-cols-2 gap-4 gap-y-4 pt-8 mx-auto">
            <StatCards
              hasImage={false}
              imageUrl='' 
              bigText='3x'
             ...
             <div className="pt-32">
              ...
              <div className="relative w-[680px] h-[420px] mx-auto">
                ...
                <div className="absolute bottom-0 left-0 p-6 text-white">
                  <p className="text-2xl text-white font-medium max-w-md mb-4">Take full control of your clubs on the go — track attendance, manage events, and coordinate members directly from our website</p>
                  <Button
                    variant="contained"
